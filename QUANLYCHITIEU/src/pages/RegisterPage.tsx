    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-md bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Tạo tài khoản mới</h2>
          <p className="text-gray-500 mt-2">Bắt đầu quản lý chi tiêu của bạn ngay hôm nay</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-between items-center text-sm pt-2">
            <Link to="/login" className="text-indigo-600 hover:text-indigo-700 font-medium">Đã có tài khoản? Đăng nhập</Link>
          </div>
        ...
        <div className="mt-8 text-center text-xs text-gray-400">
          Bằng việc đăng ký bạn đồng ý với <Link to="/terms" className="text-indigo-500 hover:underline">Điều khoản</Link> và <Link to="/privacy" className="text-indigo-500 hover:underline">Chính sách</Link>.
        </div>
      </div>
    </div>
  );
