  ...
  return (
    <div className="font-sans text-gray-800 bg-gradient-to-br from-gray-50 to-indigo-50/30">
      ...
      <nav className="fixed top-0 left-0 w-full bg-white/80 backdrop-blur-md z-50 border-b border-gray-100">
        <div className="max-w-6xl mx-auto flex justify-between items-center px-6 py-4">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm">
            ...
            <Link
              to="/login"
              className="ml-4 px-5 py-2.5 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 text-white hover:from-indigo-600 hover:to-purple-700 transition-all shadow-lg shadow-indigo-500/25 font-medium"
            >
              Đăng nhập
            </Link>
          </div>
          ...
          <div className="md:hidden">
            <Link
              to="/login"
              className="px-4 py-2 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 text-white text-sm font-medium shadow-lg shadow-indigo-500/25"
            >
              Đăng nhập
            </Link>
          </div>
          ...
          <div>
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-4">
              ...
              <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                dễ dàng, thông minh hơn
              </span>
            </h1>
            <p className="text-lg text-gray-600 mb-8 max-w-xl">
              Theo dõi thu chi, đặt mục tiêu tiết kiệm và nhận gợi ý chi tiêu
              thông minh. Giao diện trực quan, báo cáo rõ ràng.
            </p>

            <div className="flex gap-4 items-center">
              <Link
                to="/register"
                className="px-6 py-3.5 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-xl shadow-lg shadow-indigo-500/25 hover:from-indigo-600 hover:to-purple-700 hover:scale-[1.02] transition-all font-medium"
              >
                Bắt đầu miễn phí
              </Link>
              <Link
                to="/login"
                className="px-6 py-3.5 border border-gray-200 rounded-xl text-gray-700 hover:bg-white hover:shadow-md transition-all font-medium"
              >
                Đăng nhập
              </Link>
            </div>
      ...
      <section id="features" className="py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent inline-block">
              Tính năng nổi bật
            </h2>
      ...
      <section className="py-16 bg-gradient-to-br from-indigo-50/50 to-purple-50/50">
        <div className="max-w-6xl mx-auto px-6">
          <h3 className="text-2xl font-bold text-center mb-8 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent inline-block w-full">
            Người dùng nói gì
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Testimonial
              name="Lan"
              text="Ứng dụng giúp mình kiểm soát chi tiêu hàng tháng rõ ràng hơn rất nhiều."
            />
            <Testimonial
              name="Minh"
              text="Báo cáo trực quan, dễ hiểu. Mình thích tính năng mục tiêu tiết kiệm."
            />
            <Testimonial
              name="Huy"
              text="Giao diện đẹp, đồng bộ nhanh giữa điện thoại và web."
            />
          </div>
        </div>
      </section>
          ...
          <div className="space-y-4">
            <details className="p-5 bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-100 shadow-sm group">
              ...
              <p className="mt-3 text-sm text-gray-600">
                Có, bạn có thể sử dụng miễn phí với đầy đủ tính năng cơ bản.
              </p>
            </details>
            <details className="p-5 bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-100 shadow-sm group">
              <summary className="font-medium cursor-pointer text-gray-900 flex items-center justify-between">
              ...
              <p className="mt-3 text-sm text-gray-600">
                Có, bạn có thể xuất báo cáo PDF hoặc Excel để lưu trữ.
              </p>
            </details>
            <details className="p-5 bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-100 shadow-sm group">
              <summary className="font-medium cursor-pointer text-gray-900 flex items-center justify-between">
              ...
              <p className="mt-3 text-sm text-gray-600">
                Có, bạn có thể sử dụng trên web, mobile và đồng bộ dữ liệu.
              </p>
            </details>
          </div>
        </div>
      ...
      <section
        id="contact"
        className="py-20 bg-gradient-to-r from-indigo-500 to-purple-600 text-white relative overflow-hidden"
      >
        <div className="absolute inset-0 opacity-10">
          <div
            ...
            style={{
              backgroundImage:
                "url(\"data:image/svg+xml,%3Csvg width='30' height='30' viewBox='0 0 30 30' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='1.5' cy='1.5' r='1.5' fill='white'/%3E%3C/svg%3E\")",
        ...
        <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
          <h3 className="text-3xl font-bold mb-4">
            Sẵn sàng quản lý tài chính của bạn?
          </h3>
          <p className="mb-8 opacity-90 text-lg">
            Tạo tài khoản miễn phí và bắt đầu theo dõi chi tiêu ngay hôm nay.
          </p>
          <div className="flex justify-center gap-4">
            <Link
              to="/register"
              className="px-8 py-3.5 bg-white text-indigo-600 rounded-xl font-semibold hover:shadow-xl hover:scale-105 transition-all"
            >
              Tạo tài khoản
            </Link>
            <Link
              to="/login"
              className="px-8 py-3.5 border-2 border-white/30 rounded-xl font-medium hover:bg-white/10 transition-all"
            >
              Đăng nhập
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="text-sm text-gray-400">
              © {new Date().getFullYear()} ChiTiêuApp. All rights reserved.
            </div>
          </div>
          <div className="flex gap-6 text-sm">
            ...
            <a
              href="mailto:support@chitieapp.com"
              className="text-gray-400 hover:text-white transition-colors"
            >
              Contact
            </a>
