    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl w-full max-w-md max-h-[90vh] overflow-hidden shadow-2xl">
        ...
        <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-6 relative overflow-hidden">
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-indigo-100 text-sm">Thêm ví để quản lý tài chính</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          {/* Tên ví */}
          <div className="mb-5">
            <label className="block text-sm font-semibold text-gray-700 mb-2">Tên ví</label>
            <input
              value={name}
          ...
          {/* Loại ví */}
          <div className="mb-5">
            <label className="block text-sm font-semibold text-gray-700 mb-2">Loại ví</label>
            <select
              value={type}
          ...
          {/* Upload Icon */}
          <div className="mb-6">
            <label className="block text-sm font-semibold text-gray-700 mb-2">Icon (ảnh)</label>
            <div
              onDrop={onDrop}
            ...
            {preview && (
              <div className="mt-4 flex items-center gap-4 p-3 bg-gray-50 rounded-xl border border-gray-100">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-sm font-medium text-gray-800 truncate">{file?.name ?? "Ảnh đã chọn"}</div>
                  <button
                    type="button"
                    onClick={removeFile}
