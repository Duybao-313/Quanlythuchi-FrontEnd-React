    ...
    <section className="w-full">
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-12 text-gray-500">
          <svg className="w-8 h-8 animate-spin text-indigo-500 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex flex-col items-center justify-center py-12 text-gray-500">
          ...
          <span className="text-xs text-gray-400 mt-1">Các giao dịch sẽ hiển thị ở đây</span>
        </div>
      ) : (
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-3 flex-1 min-w-0">
                  <div className={`flex-shrink-0 w-10 h-10 rounded-xl flex items-center justify-center ${
                    ...
                    <svg className={`w-5 h-5 ${tx.type === "EXPENSE" ? "text-rose-500" : "text-emerald-500"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      {tx.type === "EXPENSE" ? (
